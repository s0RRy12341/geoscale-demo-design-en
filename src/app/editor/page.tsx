        ...
        <div style={{ background: theme.cardBg, borderRadius: 12, border: "1px solid " + theme.border, overflow: "hidden" }}>
          ...
          <div style={{ borderBottom: "1px solid " + theme.border, display: "flex", padding: "0 20px" }}>
            ...
            <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: theme.textSecondary }}>
              ...
              <span style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "4px 10px", borderRadius: 6, background: darkMode ? "rgba(16,163,127,0.15)" : "rgba(16,163,127,0.08)", border: "1px solid " + (darkMode ? "rgba(16,163,127,0.3)" : "rgba(16,163,127,0.2)"), color: "#10A37F", fontSize: 14, fontWeight: 500 }}>
          ...
          <div style={{ padding: isMobile ? "16px 16px" : "32px 48px", minHeight: isMobile ? 400 : 600 }}>
            <input defaultValue="Therapeutic Riding for Children with ADHD — Complete 2026 Guide" style={{
              width: "100%", fontSize: isMobile ? 22 : 30, fontWeight: 600, border: "none", outline: "none", marginBottom: 16, color: theme.text, background: "transparent",
            }} />
            ...
            <h2 style={{ fontSize: 24, fontWeight: 500, marginTop: 32, marginBottom: 14, color: theme.text }}>What is therapeutic riding?</h2>
            <p style={{ fontSize: 16, lineHeight: 1.8, color: darkMode ? "#C9D1D9" : "#222", marginBottom: 20 }}>
            ...
            <h2 style={{ fontSize: 24, fontWeight: 500, marginTop: 32, marginBottom: 14, color: theme.text }}>5 key benefits for children with ADHD</h2>
            ...
            <h2 style={{ fontSize: 24, fontWeight: 500, marginTop: 32, marginBottom: 14, color: theme.text }}>How to choose a therapeutic riding ranch</h2>
            <p style={{ fontSize: 16, lineHeight: 1.8, color: darkMode ? "#C9D1D9" : "#222", marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ background: theme.cardBg, borderRadius: 12, border: "1px solid " + theme.border, padding: 18 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
              <div style={{ width: 28, height: 28, borderRadius: 14, background: "#10A37F", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 14, fontWeight: 500 }}>{"✦"}</div>
              <div style={{ fontSize: 15, fontWeight: 500, color: theme.text }}>AI learning from your edits</div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
              <span style={{ fontSize: 22, fontWeight: 500, color: theme.text }}>37</span>
          ...
          <div style={{ background: theme.cardBg, borderRadius: 12, border: "1px solid " + theme.border, padding: 18 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
              <div style={{ fontSize: 15, fontWeight: 500, color: theme.text }}>SEO check — Nir&apos;s prompt</div>
              <span style={{ fontSize: 14, padding: "2px 8px", borderRadius: 10, background: "#10A37F15", color: "#10A37F", fontWeight: 500 }}>8/10</span>
            </div>
          ...
          {/* Quick stats */}
          <div style={{ background: theme.cardBg, borderRadius: 12, border: "1px solid " + theme.border, padding: 18 }}>
            <div style={{ fontSize: 15, fontWeight: 500, marginBottom: 12, color: theme.text }}>Real-time metrics</div>
            {[
